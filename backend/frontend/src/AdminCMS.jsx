...
const sectionHelp = (sectionKey) => sectionKey === 'faq-items' ? 'Enter one question and answer per line, separated by ||.' : 'This updates the existing public section without changing its layout.'
