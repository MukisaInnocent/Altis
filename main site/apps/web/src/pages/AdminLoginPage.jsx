...
export default function AdminLoginPage() {
    ...
    return (
        <>
            <Helmet>
                <title>Staff Sign In — Altis Voyage</title>
                <meta name="description" content="Administrator sign in for the Altis Voyage content dashboard." />
            </Helmet>
            <div className="flex min-h-screen items-center justify-center bg-background px-4">
                <div className="brackets w-full max-w-md border border-border bg-card p-9 text-accent">
                    <div className="flex items-center gap-2">
                        <Compass className="h-6 w-6 text-accent" />
                        <span className="font-display text-lg font-bold text-foreground">Altis Voyage</span>
                    </div>
