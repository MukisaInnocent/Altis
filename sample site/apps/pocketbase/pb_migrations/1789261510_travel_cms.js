...
migrate(
  (app) => {
    ...
    try {
      app.findAuthRecordByEmail("users", "admin@pearlofafrica.travel");
    } catch (_) {
      const admin = new Record(users);
      admin.setEmail("admin@pearlofafrica.travel");
      admin.setPassword("PearlAdmin!2026#Ug");
    ...
    seed(siteContent, "key", [
      { key: "hero", value: { title: "From the Pearl of Africa to the World", subtitle: "Uganda-based, worldwide in reach. Safaris at home, journeys abroad — planned, booked and supported by people who answer the phone.", image: IMG.hero, ctaPrimary: "Explore Destinations", ctaSecondary: "Plan Your Trip" } },
      { key: "contact", value: { phone: "+256 700 123 456", email: "hello@pearlofafrica.travel", address: "Plot 12, Kampala Road, Kampala, Uganda", hours: "Mon–Sat, 8:30–18:00 EAT" } },
      { key: "about", value: { heading: "A Ugandan agency with a global map", body: "We help Ugandans travel internationally, welcome visitors to Uganda, and support journeys everywhere in between — visas, flights, stays, safaris and 24/7 support." } },
    ]);
  },
  (app) => {
    ...
    try {
      app.delete(app.findAuthRecordByEmail("users", "admin@pearlofafrica.travel"));
    } catch (e) {
