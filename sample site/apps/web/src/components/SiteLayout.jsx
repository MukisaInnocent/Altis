            ...
            <header className="sticky top-0 z-40 border-b border-border bg-background/92 backdrop-blur">
                <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
                    <Link to="/" className="flex items-center gap-2">
                        <Compass className="h-6 w-6 text-accent" strokeWidth={1.8} />
                        <span className="font-display text-lg font-bold leading-none">
                            Pearl of Africa <span className="text-accent">Travel</span>
                        </span>
                    </Link>
            ...
            <footer className="mt-24 bg-primary text-primary-foreground">
                <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 md:grid-cols-4">
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-display text-lg font-bold">Pearl of Africa Travel</span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-sm opacity-80">
                            <li className="flex items-center gap-2">
                                <Phone className="h-4 w-4" /> {contact?.phone || '+256 700 123 456'}
                            </li>
                            <li>{contact?.email || 'hello@pearlofafrica.travel'}</li>
                            <li>{contact?.address || 'Plot 12, Kampala Road, Kampala, Uganda'}</li>
                ...
                <div className="border-t border-primary-foreground/15">
                    <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-5 text-xs opacity-70">
                        <span>© {new Date().getFullYear()} Pearl of Africa Travel Ltd. Kampala, Uganda.</span>
